...
This is a simple script to download all [VVR](https://www.vrr.de) stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
